...
# Q 42 al-Shūrā — investigation journal

## 2026-04-28 — full-template completion

### Garden-of-forking-paths log (BEFORE Q042-F-01)

- Set of 29 muqaṭṭaʿāt-opened surahs locked: [Q 2, 3, 7, 10, 11, 12, 13, 14, 15, 19, 20, 26, 27, 28, 29, 30, 31, 32, 36, 38, 40, 41, 42, 43, 44, 45, 46, 50, 68].
- "is_muqattaat_only" criterion: single-token verse, all Arabic letters, length ≤ 6 graphemes.
- Direction: pre-committed only Q 42 has v.1+v.2 muqaṭṭaʿāt.

### Run timeline

1. Pre-flight: existing 00, 01, 02 reviewed.
2. 03 tafsir written (al-Ṭabarī, al-Zamakhsharī, al-Rāzī, al-Qurṭubī, al-Biqāʿī, Ibn Kathīr, al-Suyūṭī).
3. 04 hadith pull: 3 Q 42:23 hits (Bukhārī ×2, Tirmidhī ×1).
4. 05 audit: 7 claims audited; all VINDICATED or DOCUMENTED.
5. Pre-registered Q042-F-01 at SHA `c96f4e46...`.
6. Ran script → Q 42 unique → VINDICATED.
7. **Discovered (post-hoc, but reported separately as Finding 2)**: Q 42 → Q 43 FR-distance is 0.9912, the costliest HM-7 transition.
8. **Correction (this session)**: Q 42 is HM-7 UAS leader (rank 31), not Q 41. Recorded in 06.
9. Wrote 06, 07, JOURNAL.

### NULLs and corrections (equal prominence)

- **Self-correction**: Earlier scaffolds asserted Q 41 was UAS-leader of HM-7. Re-derivation shows Q 42 leads. Recorded in 06 (Finding 4) and Q 41's JOURNAL.
- **Q 42:23 sectarian readings**: DOCUMENTED — both classical-Sunni (Quraysh-kinship) and Imāmī (Ahl al-Bayt) readings are valid; not adjudicable empirically.
- **Q 42:1-2 Ḥudhayfa eschatological reading**: classified by al-Ṭabarī as *gharīb ʿajīb munkar*; weak isnād.

### Pre-commit honoring

- Q042-F-01 direction (Q 42 unique) MATCHED.
- Finding 2 (Q 42-Q 43 FR-cost) is **post-hoc**; capped at MW-7 single-test α.

### Verdict

Q 42 al-Shūrā investigation **COMPLETE**. One pre-registered novel finding (Q042-F-01) VINDICATED at exact-uniqueness. Two-verse muqaṭṭaʿāt + ر-shifted multi-rāwī + HM-7 UAS-leader (rank 31) + costliest-HM-7-transition partner (Q 42-Q 43 FR=0.9912) make Q 42 the **multi-axis architectural exception within HM-7**.
